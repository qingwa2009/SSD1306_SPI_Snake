...
#define CSX_OUTPUT MYPIN_WRITE_MODE_(CS_PIN)
#define CSX_HIGH MYPIN_WRITE_HIGH_(CS_PIN)
#define CSX_LOW MYPIN_WRITE_LOW_(CS_PIN)

#define DC_OUTPUT MYPIN_WRITE_MODE_(DC_PIN)
#define CMD_MODE MYPIN_WRITE_LOW_(DC_PIN)
#define DATA_MODE MYPIN_WRITE_HIGH_(DC_PIN)
